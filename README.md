...
Shared foundation library for [Ansilithic](https://github.com/ansilithic) CLI tools. Provides terminal styling, table formatting, structured output, and standard exit codes.
